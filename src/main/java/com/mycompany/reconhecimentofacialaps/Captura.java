...
public class Captura {
    ...
    public static void main(String[] args) throws FrameGrabber.Exception {
        ...
        Captura teste = new Captura();
        //teste.cadastrarFace();
        
       // Treinamento tre = new Treinamento();
        //tre.treinar();
        
        teste.identificarFace();

        //teste.identificarFace();
    }

    public boolean cadastrarFace() throws FrameGrabber.Exception {
        boolean teste = false;
    ...
    public boolean identificarFace() throws FrameGrabber.Exception {
        boolean teste = false;
        ...
        while ((frameCapturado = camera.grab()) != null) { // enquanto estiver capturando coisa da webcam
            ...
            for (int i = 0; i < facesDetectadas.size(); i++) {
                ...
                if (identificador == -1 || erro.get(0) > 300) {
                    name = "Desconhecido";
                    //erroAcesso = true;
